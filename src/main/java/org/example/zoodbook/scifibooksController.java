...
public class scifibooksController {
    private Stage stage;
    private Scene scene;
    private Parent root;
    @FXML
    ...
    public void initialize() throws IOException, NoSuchFieldException, IllegalAccessException {
        if (uId != 100) {
            ...
            for (int i = 1; i < 9; i++) {
                ...
                productButtonMap.put("s" + i, button);
            }
